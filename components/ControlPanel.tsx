...
import { 
  ...
  PenTool, Ruler, Save, FolderOpen, FlaskConical, Scan, History
} from 'lucide-react';
...
export const ControlPanel: React.FC = () => {
  ...
  const rangeClass = "w-full h-1 bg-slate-700 rounded-lg appearance-none cursor-pointer accent-blue-500";
  const panelSectionClass = "border border-slate-700 p-3 rounded bg-[#101c2e] shadow-sm";

  return (
    <div className="w-96 h-full flex flex-col z-10 overflow-hidden tech-panel border-r border-slate-800 bg-[#101c2e]/95">
      <div className="p-4 border-b border-slate-800 bg-[#0b1220]">
        <h1 className="text-xl font-bold text-slate-100 flex items-center gap-2 tracking-tight">
          <Radar className="text-blue-500" />
          ANTENNA<span className="text-blue-400">VIZ</span>
          <span className="text-[10px] align-top bg-blue-900/30 border border-blue-800 text-blue-400 px-1 rounded ml-1">AI</span>
        </h1>
        <p className="text-[10px] text-slate-500 font-mono mt-1">HỆ THỐNG MÔ PHỎNG SÓNG VÔ TUYẾN</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        <div className="grid grid-cols-2 gap-2">
            ...
            >
                <Activity size={14} /> BIỂU ĐỒ SMITH
            </button>
            <button 
        ...
        <div className="grid grid-cols-2 gap-2">
            ...
            >
                <Calculator size={14} /> QUỸ ĐƯỜNG TRUYỀN
            </button>
            <button 
        ...
        <div className="grid grid-cols-2 gap-2">
            ...
            >
                <Activity size={14} /> MIỀN THỜI GIAN
            </button>
            <button 
      ...
      <div className="p-4 border-t border-slate-800 bg-[#0b1220] space-y-2">
        {/* Save/Load Row */}
        <div className="grid grid-cols-2 gap-2">
